...
int main (int argc, char *argv[])
{
  ...
  char ula_op = 0;
    ...
    /* Memory. */
    memory[0] = 0x8c480000;  // 100011 00010 01000 0000000000000000      lw $t0, 0($v0) *5*
    memory[1] = 0x010c182a;  // 000000 01000 01100 00011 00000 101010    slt $v1, $t0, $t4 *4*
    memory[2] = 0x05420004;  // 000001 01010 00010 0000000000000100      bltzal $t2, fim(4 palavras abaixo de PC+4) *3*
    memory[3] = 0x21080005;  // 001000 01000 01000 0000000000000101      addi $t0, $t0, 5
    ...
    memory[6] = 0x0c000000;  // 000011 00000 00000 0000000000000000      jal inicio (palavra 0) *3*
    memory[7] = 0;           // Parada.
    memory[8] = 0;  // 1010 1100 0100 1000 0000 0000 0000 0000  sw $t0, 0($v0) *4*
    memory[9] = 0;  // 000000 01000 01000 01000 00000100000     add $t0, $t0, $t0 *4*
